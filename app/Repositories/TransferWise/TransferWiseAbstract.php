...
abstract class TransferWiseAbstract {
    ...
    /** @var string  */
    public $liveURI = 'https://api.transferwise.com/v1/';
    ...
    public function get(string $uri, array $data = []) {
        ...
        $response =  $this->_httpClient->request('GET', $uri, $options);
        return json_decode($response->getBody()->getContents(), true);
    }
    ...
    private function _setDefaultApiToken() : void {
        $token = 'b8e08eaa-86e7-4386-9a9f-6e1e4035e7ce';
